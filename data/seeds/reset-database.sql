...
\COPY element_types(id, service_id, name, subjective_code, framework_subjective_code, type, cost_type, billing, non_personal_budget, position, is_archived, is_s117) FROM 'element_types.csv' CSV HEADER;
