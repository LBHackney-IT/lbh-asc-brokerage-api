...
namespace V1.Infrastructure.Migrations
{
    ...
    [Migration("20220527100515_RenameAssignedUsersWithId")]
    partial class RenameAssignedUsersWithId
    {
            ...
            modelBuilder.Entity("BrokerageApi.V1.Infrastructure.CarePackage", b =>
                {
                    ...
                    b.Property<int?>("AssignedBrokerId")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BrokerageApi.V1.Infrastructure.CarePackage", b =>
                {
                    b.HasOne("BrokerageApi.V1.Infrastructure.User", "AssignedApprover")
                        ...
                        .HasConstraintName("fk_care_packages_users_assigned_approver_id");

                    b.HasOne("BrokerageApi.V1.Infrastructure.User", "AssignedBroker")
                        .WithMany()
                        .HasForeignKey("AssignedBrokerId")
                        .HasConstraintName("fk_care_packages_users_assigned_broker_id");
