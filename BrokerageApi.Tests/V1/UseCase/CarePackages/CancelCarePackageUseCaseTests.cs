...
namespace BrokerageApi.Tests.V1.UseCase.CarePackages
{
    public class CancelCarePackageUseCaseTests
    {
        ...
        public async Task CanCancelCarePackage()
        {
            ...
            await _classUnderTest.ExecuteAsync(referral.Id, null);

            foreach (var element in elements)
            {
                _mockEndElementUseCase.Verify(x => x.ExecuteAsync(referral.Id, element.Id, null), Times.Once);
            }
        ...
        public async Task ThrowsArgumentNullExceptionWhenReferralNotFound()
        {
            ...
            Func<Task> act = () => _classUnderTest.ExecuteAsync(unknownReferralId, null);
        ...
        public async Task AddsAuditTrail()
        {
            ...
            _mockAuditGateway.VerifyAuditEventAdded(AuditEventType.CarePackageCancelled);
