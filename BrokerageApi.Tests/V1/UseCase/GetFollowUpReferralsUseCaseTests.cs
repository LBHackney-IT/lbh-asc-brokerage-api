...
namespace BrokerageApi.Tests.V1.UseCase
{
    ...
    public class GetFollowUpReferralsUseCaseTests
    {
        private Mock<IReferralGateway> _mockReferralGateway;
        private GetFollowUpReferralsUseCase _classUnderTest;
        ...
        public void Setup()
        {
            ...
            _classUnderTest = new GetFollowUpReferralsUseCase(
