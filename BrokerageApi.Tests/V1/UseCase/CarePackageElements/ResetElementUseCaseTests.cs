...
{
    public class ResetElementUseCaseTests
    {
        private Fixture _fixture;
        private ResetElementUseCase _classUnderTest;
        ...
        public void Setup()
        {
            ...
            _classUnderTest = new ResetElementUseCase(
        ...
        [Test]
        public async Task DeletesElementWhenHasParentElementAndInProgress()
        {
            ...
            _mockDeleteElementUseCase.Verify(x => x.ExecuteAsync(referral.Id, element.Id), Times.Once);
        }

        [Test]
        public async Task RemovesPendingValuesWhenElementApproved()
        {
            var element = _fixture.BuildElement(1, 1)
                .With(e => e.InternalStatus, ElementStatus.Approved)
                .Create();
        ...
        [Test]
        public async Task DeletesInProgressSuspensionElementsWhenApproved()
        {
