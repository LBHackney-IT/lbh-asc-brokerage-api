using AutoFixture;
using BrokerageApi.Tests.V1.Helper;
...
namespace BrokerageApi.Tests.V1.Gateways
{
    ...
    //For instruction on how to run tests please see the wiki: https://github.com/LBHackney-IT/lbh-brokerage-api/wiki/Running-the-test-suite.
    [TestFixture]
